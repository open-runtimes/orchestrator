...
func (c *httpClient) Claim(ctx context.Context, podIP, token string, req *proxy.ClaimRequest) error {
	return c.poster.Post(ctx, claim.Unit{Addr: podIP, Token: token}, req)
}

func (c *httpClient) State(ctx context.Context, podIP string) (*proxy.ClaimState, error) {
